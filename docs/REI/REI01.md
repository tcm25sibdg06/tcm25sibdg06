...
Responsável pela prestação de cuidados médicos aos animais, incluindo diagnóstico, acompanhamento clínico, prescrição de tratamentos e definição de procedimentos como cirurgias ou exames complementares.

**Enfermeiro Veterinário / Auxiliar Clínico**

Responsável pelo apoio ao médico veterinário durante os procedimentos clínicos, incluindo a administração de vacinas, preparação de material clínico e assistência em tratamentos e cirurgias.

**Tosador (Serviços Estéticos)**

Responsável pela realização de serviços de higiene e estética animal, como banho, tosquia e corte de unhas, assegurando o bem-estar e a apresentação dos animais.

**Gestor da Clínica**

Responsável pela análise e supervisão global do funcionamento da clínica, incluindo consultas, serviços prestados, recursos humanos e desempenho operacional.

**Funcionalidades**

Cada utilizador poderá ter acesso às seguintes funcionalidades dentro do sistema:

**Rececionista da Clínica**
Registo de novos donos, incluindo nome, telefone e NIF.
Registo e atualização de animais associados aos respetivos donos, com nome, data de nascimento, espécie, raça e caderno de vacinação.
Verificação de registos existentes de donos e animais no sistema.
...
Análise do funcionamento geral da clínica.
Gestão global da operação e apoio à tomada de decisão.

#### Nota Final

Os clientes (donos dos animais) não terão acesso direto ao sistema de gestão da clínica. A plataforma será utilizada exclusivamente pelos profissionais da clínica, permitindo uma gestão centralizada de informação, melhor coordenação entre equipas e maior eficiência na prestação de cuidados aos animais.
